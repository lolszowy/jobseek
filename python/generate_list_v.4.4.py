...
try:
    ...
    print("Module has not benn installed yet. Run \"pip3 install tqdm\"")
...
DEBUG_ON = (cfg.progress_bar['debug_on'])
...
loop = tqdm(total = item_count, position = 0, leave= False)
print('Porownuje dane')
